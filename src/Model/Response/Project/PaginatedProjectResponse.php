...
#[OA\Schema(schema: 'PaginatedProjectResponse')]
final readonly class PaginatedProjectResponse
{
    /**
    ...
    public function __construct(
        #[OA\Property(type: 'array', items: new OA\Items(ref: '#/components/schemas/ProjectResponse'))]
        public array $data,
